...
def load_test_data(data_cfg, sequence_field, signer_field, sgn_field, gls_field, txt_field):
...
def load_dictionary(data_cfg: dict) -> (Dataset, Dataset, Dataset, Vocabulary, Vocabulary):
    ...
    return gls_vocab, txt_vocab, sequence_field, signer_field, sgn_field, gls_field, txt_field
